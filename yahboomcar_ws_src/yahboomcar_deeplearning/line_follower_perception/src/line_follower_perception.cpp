...
LineFollowerPerceptionNode::LineFollowerPerceptionNode(const std::string& node_name,
  ...
  this->declare_parameter("model_path", "/userdata/yahboomcar_ws/src/yahboomcar_deeplearning/line_follower_perception/model/resnet18_224x224_nv12.bin");
  ...
  subscriber_ =
    this->create_subscription_hbmem<hbm_img_msgs::msg::HbmMsg1080P>(
      ...
      this,
      std::placeholders::_1)); 
  joy_subscriber_ = this->create_subscription<std_msgs::msg::Bool>(
      "/JoyState", 
      10,
      std::bind(&LineFollowerPerceptionNode::JoyStateCallback,
      this,
      std::placeholders::_1)); 
}
...
void LineFollowerPerceptionNode::JoyStateCallback(
  const std_msgs::msg::Bool::SharedPtr msg) {
  this->JoyActivate = msg->data;
}
